...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_exp)){
        ...
        $exp_err = "Please enter a valid expiry_date.";
    }else{
...
// BLOCK ENDS HERE*/
    ...
    if(empty($name_err) && empty($code_err) && empty($exp_err)){
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>code</label>
                            <input type="text"name="code" class="form-control <?php echo (!empty($code_err)) ? 'is-invalid' : ''; ?>" 
                            value="<?php echo $code; ?>">
